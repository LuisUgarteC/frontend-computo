                    ...
                    <transition name="slide-fade-up">
                      <div v-if="cardName.length" key="1" class="card-item__name">
                        <transition-group name="slide-fade-right">
                          <span v-for="(n, $index) in processedCardName" :key="$index + 1" class="card-item__nameItem">{{ n }}</span>
                        </transition-group>
                      </div>
                      <div v-else key="2" class="card-item__name">Nombre Completo</div>
                    </transition>
                  </label>
